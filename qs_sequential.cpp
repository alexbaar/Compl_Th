...
int main()
{
	...
	for (int i = 0; i < N; i++) {
		A[i] = -99999999; // Set to a large negative value (guaranteed to be outside the range)
	}

	// Initialize array with random values
	uniform_int_distribution<int> dist(-40000000, 40000000); 

	// Generate random values between -100 and 100 and assign them to A[i]
	// the number from line 64 will be overwritten
	for (int i = 0; i < N; i++) {
